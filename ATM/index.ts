        ...
        [
                {
                        ...
                        type : "list", 
                        choices: ["cashWithdrawal", "Check Balance", "fast cash"]
                }
        ]
)
...
let amountAns = await inquirer.prompt(
        ...
        if (mybalance  <= amountAns.amount){console.log("unsufficient amount")}
